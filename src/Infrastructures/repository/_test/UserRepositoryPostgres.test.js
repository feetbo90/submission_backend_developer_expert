...
describe('UserRepositoryPostgres', () => {
  ...
  describe('getUsernameById', () => {
    it('should throw InvariantError when user not found', async () => {
      ...
      // Action & Assert
      await expect(userRepositoryPostgres.getUsernameById('user-12345678'))
        .rejects
        .toThrowError(InvariantError);
    });
    ...
    it('should return user id correctly', async () => {
      // Arrange
      await UsersTableTestHelper.addUser({ id: 'user-12345678', username: 'dicoding' });
      const userRepositoryPostgres = new UserRepositoryPostgres(pool, {});

      // Action
      const userId = await userRepositoryPostgres.getUsernameById('user-12345678');
